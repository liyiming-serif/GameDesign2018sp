...
#pragma mark -
#pragma mark SliderListener

/**
 * @typedef SliderListener
 *
 ...
 */
typedef std::function<void(const std::string& name, float value)> SliderListener;
...
#pragma mark Listeners
	 ...
	 */
	const SliderListener getListener() const { return _listener; }
     ...
     */
	void setListener(SliderListener listener) { _listener = listener; }
     ...
     * {@link SliderListener} attached, it will call that function upon any
     * state changes.
     *
    ...
    * method. In addition, any {@link SliderListener} attached will still
