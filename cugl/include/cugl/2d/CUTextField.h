 ...
 */
typedef std::function<void (const std::string& name, const std::string& current)> TextFieldListener;
...
#pragma mark Listener
   ...
   /**
	 ...
	 */
    const TextFieldListener getTypeListener() const { return _typeListener; }
     ...
     */
    void setTypeListener(TextFieldListener listener) { _typeListener = listener; }
     ...
     */
    const TextFieldListener getExitListener() const { return _exitListener; }
     ...
     */
    void setExitListener(TextFieldListener listener) { _exitListener = listener; }
