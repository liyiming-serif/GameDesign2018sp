...
#pragma mark -
#pragma mark TouchMotionListener

/**
 * @typedef TouchMotionListener
 *
...
public:
     ...
     * {@link touchPosition(TouchID)} or {@link touchOffset(TouchID)}.
     *
     ...
     * it will be unsafe to call either {@link touchPosition(TouchID)} or 
     * {@link touchOffset(TouchID)}.
     *
     * @param touch An identifier for a touch/finger
     *
