...
#pragma mark -
#pragma mark MouseButtonListener
 ...
 */
typedef std::function<void(const MouseEvent& event, Uint8 clicks, bool focus)>
        MouseButtonListener;

#pragma mark -
#pragma mark MouseMotionListener

/**
 * @typedef MouseMotionListener
 *
 ...
 * @param focus     Whether the listener currently has focus
 */
typedef std::function<void(const MouseEvent& event, const Vec2& previous, bool focus)>
        MouseMotionListener;

#pragma mark -
#pragma mark MouseWheelListener

/**
 * @typedef MouseWheelListener
 *
 ...
 * @param focus     Whether the listener currently has focus
 */
typedef std::function<void(const MouseWheelEvent& event, bool focus)>
        MouseWheelListener;
