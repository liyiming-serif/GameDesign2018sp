...
#pragma mark -
#pragma mark AccelerationListener
/**
 * @typedef AccelerationListener
 *
 ...
 * {@link getThreshold()} for more information.
 *
...
private:
    ...
    std::unordered_map<Uint32, AccelerationListener> _listeners;
...
#pragma mark Data Polling
     ...
     */
    float getTreshold() const { return _threshold; }
