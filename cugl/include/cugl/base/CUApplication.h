 ...
 * with any type of graphics.  If you want an application optimized for 2d
 * games, you should use the subclass {@link SceneApplication}.
 *
...
private:
    ...
    /** The SDL timestamp for the start of an animation frame */
    Uint32 _start;
    /** The SDL timestamp for the end of an animation frame */
    Uint32 _finish;
