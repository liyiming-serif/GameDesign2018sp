 ...
 *
 * {@link ComplexTriangulator}: This is a wrapper for the advanced Poly2Tri 
 * triangulator.  This triangulator can tesselate complex solid polygons (e.g. 
 * those with holes or self-intersections).
 * 
 ...
 * to the indices.
 *
 * {@link PolygonClipper}: This is a wrapper for the Clipper package, which
 * provides 2d constructive area geometry support.  It allows you to compute
 * the intersection or union of multiple solid polygons.  Like PathExtruder, it
 * also generates new vertices in addition to the indices.
 */
class Poly2 {
#pragma mark Values
public:
