 ...
 */
const MouseButtonListener Mouse::getPressListener(Uint32 key) const {
 ...
 */
const MouseButtonListener Mouse::getReleaseListener(Uint32 key) const {
 ...
 */
const MouseMotionListener Mouse::getDragListener(Uint32 key) const {
 ...
 */
const MouseMotionListener Mouse::getMotionListener(Uint32 key) const {
 ...
 */
const MouseWheelListener Mouse::getWheelListener(Uint32 key) const {
 ...
 */
bool Mouse::addPressListener(Uint32 key, MouseButtonListener listener) {
    if (_pressListeners.find(key) == _pressListeners.end()) {
 ...
 * @return true if the listener was succesfully added
 */
bool Mouse::addReleaseListener(Uint32 key, MouseButtonListener listener) {
    if (_releaseListeners.find(key) == _releaseListeners.end()) {
 ...
 * @return true if the listener was succesfully added
 */
bool Mouse::addDragListener(Uint32 key, MouseMotionListener listener) {
 ...
 * @return true if the listener was succesfully added
 */
bool Mouse::addMotionListener(Uint32 key, MouseMotionListener listener) {
 ...
 * @return true if the listener was succesfully added
 */
bool Mouse::addWheelListener(Uint32 key, MouseWheelListener listener) {
    if (_wheelListeners.find(key) == _wheelListeners.end()) {
