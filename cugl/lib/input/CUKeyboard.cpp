 ...
 */
const KeyListener Keyboard::getKeyDownListener(Uint32 key) const {
 ...
 */
const KeyListener Keyboard::getKeyUpListener(Uint32 key) const {
 ...
 */
bool Keyboard::addKeyDownListener(Uint32 key, KeyListener listener) {
    if (_downListeners.find(key) == _downListeners.end()) {
 ...
 * @return true if the listener was succesfully added
 */
bool Keyboard::addKeyUpListener(Uint32 key, KeyListener listener) {
    if (_upListeners.find(key) == _upListeners.end()) {
