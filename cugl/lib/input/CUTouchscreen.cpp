 ...
 */
const TouchListener Touchscreen::getBeginListener(Uint32 key) const {
 ...
 */
const TouchListener Touchscreen::getEndListener(Uint32 key) const {
 ...
 */
const TouchMotionListener Touchscreen::getMotionListener(Uint32 key) const {
 ...
 */
bool Touchscreen::addBeginListener(Uint32 key, TouchListener listener) {
    if (_beginListeners.find(key) == _beginListeners.end()) {
 ...
 * @return true if the listener was succesfully added
 */
bool Touchscreen::addEndListener(Uint32 key, TouchListener listener) {
    if (_finishListeners.find(key) == _finishListeners.end()) {
 ...
 * @return true if the listener was succesfully added
 */
bool Touchscreen::addMotionListener(Uint32 key, TouchMotionListener listener) {
    if (_moveListeners.find(key) == _moveListeners.end()) {
