 ...
 */
const RotationListener RotationInput::getBeginListener(Uint32 key) const {
 ...
 */
const RotationListener RotationInput::getEndListener(Uint32 key) const {
 ...
 */
const RotationListener RotationInput::getChangeListener(Uint32 key) const {
 ...
 */
bool RotationInput::addBeginListener(Uint32 key, RotationListener listener) {
    if (_beginListeners.find(key) == _beginListeners.end()) {
 ...
 * @return true if the listener was succesfully added
 */
bool RotationInput::addEndListener(Uint32 key, RotationListener listener) {
    if (_finishListeners.find(key) == _finishListeners.end()) {
 ...
 * @return true if the listener was succesfully added
 */
bool RotationInput::addChangeListener(Uint32 key, RotationListener listener) {
    if (_changeListeners.find(key) == _changeListeners.end()) {
