 ...
 */
const PanListener PanInput::getBeginListener(Uint32 key) const {
 ...
 */
const PanListener PanInput::getEndListener(Uint32 key) const {
 ...
 */
const PanListener PanInput::getMotionListener(Uint32 key) const {
 ...
 */
bool PanInput::addBeginListener(Uint32 key, PanListener listener) {
    if (_beginListeners.find(key) == _beginListeners.end()) {
 ...
 * @return true if the listener was succesfully added
 */
bool PanInput::addEndListener(Uint32 key, PanListener listener) {
    if (_finishListeners.find(key) == _finishListeners.end()) {
 ...
 * @return true if the listener was succesfully added
 */
bool PanInput::addMotionListener(Uint32 key, PanListener listener) {
    if (_motionListeners.find(key) == _motionListeners.end()) {
