 ...
 */
const PinchListener PinchInput::getBeginListener(Uint32 key) const {
 ...
 */
const PinchListener PinchInput::getEndListener(Uint32 key) const {
 ...
 */
const PinchListener PinchInput::getChangeListener(Uint32 key) const {
 ...
 */
bool PinchInput::addBeginListener(Uint32 key, PinchListener listener) {
    if (_beginListeners.find(key) == _beginListeners.end()) {
 ...
 * @return true if the listener was succesfully added
 */
bool PinchInput::addEndListener(Uint32 key, PinchListener listener) {
    if (_finishListeners.find(key) == _finishListeners.end()) {
 ...
 * @return true if the listener was succesfully added
 */
bool PinchInput::addChangeListener(Uint32 key, PinchListener listener) {
    if (_changeListeners.find(key) == _changeListeners.end()) {
