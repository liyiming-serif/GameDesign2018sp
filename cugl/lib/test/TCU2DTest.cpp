...
#pragma mark Basic Constructor Test
    ...
    CUAssertLog(test1.getAnchor() == Vec2::ANCHOR_MIDDLE,   "Constructor failed");
...
#pragma mark Basic Initializer Test
    ...
    CUAssertLog(test1.getAnchor() == Vec2::ANCHOR_MIDDLE,   "Method initWithPosition() failed");
    ...
    CUAssertLog(test1.getAnchor() == Vec2::ANCHOR_MIDDLE,   "Method dispose() failed");
    ...
    CUAssertLog(test1.getAnchor() == Vec2::ANCHOR_MIDDLE,   "Method initWithBounds() failed");
...
#pragma mark Static Constructor Test
    ...
    CUAssertLog(testptr1->getAnchor() == Vec2::ANCHOR_MIDDLE,   "Node::create() failed");
    ...
    CUAssertLog(testptr1->getAnchor() == Vec2::ANCHOR_MIDDLE,   "Node::createWithPosition() failed");
    ...
    CUAssertLog(testptr1->getAnchor() == Vec2::ANCHOR_MIDDLE,   "Node::createWithBounds() failed");
...
#pragma mark Size Test
    ...
    Vec2 tmp1 = test1.getPosition();
    Vec2 tmp2 = test1.getWorldPosition();
...
#pragma mark Anchor Test
    ...
    test1.setAnchor(Vec2::ANCHOR_MIDDLE_TOP);
    CUAssertLog(test1.getAnchor() == Vec2::ANCHOR_MIDDLE_TOP,   "Method setAnchor() failed");
    ...
    CUAssertLog(test1.getBoundingBox() == Rect(0,1,2,4),        "Method setAnchor() failed");
    test1.setAnchor(Vec2::ANCHOR_MIDDLE_BOTTOM);
    CUAssertLog(test1.getAnchor() == Vec2::ANCHOR_MIDDLE_BOTTOM,"Method setAnchor() failed");
