...
std::vector<unsigned short> PathOutliner::getPath() {
 ...
 */
size_t PathOutliner::getPath(std::vector<unsigned short>& buffer) {
    if (_calculated) {
 ...
 */
Poly2* PathOutliner::getPolygon(Poly2* buffer) {
