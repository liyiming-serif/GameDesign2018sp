...
//
//  This implementation is largely copied from the LibGDX implementation by
 ...
 */
std::vector<unsigned short> SimpleTriangulator::getTriangulation() {
 ...
 */
size_t SimpleTriangulator::getTriangulation(std::vector<unsigned short>& buffer) {
    if (_calculated) {
 ...
 */
Poly2 SimpleTriangulator::getPolygon() {
    Poly2 poly;
    if (_calculated) {
 ...
 */
Poly2* SimpleTriangulator::getPolygon(Poly2* buffer) {
